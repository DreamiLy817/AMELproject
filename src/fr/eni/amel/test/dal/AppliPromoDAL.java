...
//		}
		...
		List<Promotion> listeRecherchePromotions = DaoFactory.getPromotionDao().rechercherPromotion("DL");
		for (Promotion promoRecherche : listeRecherchePromotions) {
			System.out.println(promoRecherche);
		}
	}
